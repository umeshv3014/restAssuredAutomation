...
System.setProperty("webdriver.chrome.driver", MAC_CHROMEDRIVER_PATH);
			...
			driver.findElement(By.cssSelector("input[type='email']")).sendKeys("umeshv3014@gmail.com");
	...
	String accessToken=js.getString("access_token");
		...
		List<apiPayLoads.Api> apiCourses=gc.getCourses().getApi();
		...
		List<apiPayLoads.WebAutomation> w=gc.getCourses().getWebAutomation();
