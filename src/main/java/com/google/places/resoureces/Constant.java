...
public class Constant {
	public static final String CONFIGURATION_PROPERTIES = "resources/Config.properties";
	public static final String CONFIGURATION_PAYLOAD_XML = "resources/addGooglePlaces.xml";
